...
class TestE2EAdminResponses(TestCase):
    EXPECTED = [
        ...
        "DOCUMENTS edit page ...",
        "========================",
        "http://localhost:8000/admin/documents/edit/1/ ← 404",
        "",
        "GROUPS list page ...",
        "=====================",
        ...
        "IMAGES edit page ...",
        "=====================",
        "http://localhost:8000/admin/images/1/ ← 404",
        "",
        ...
        "SETTINGS edit pages ...",
        "========================",
        "http://localhost:8000/admin/settings/wagtail_devtools_test/genericsettingone/1/ ← 404",
        "http://localhost:8000/admin/settings/wagtail_devtools_test/genericsettingtwo/1/ ← 404",
        "http://localhost:8000/admin/settings/wagtail_devtools_test/genericsettingthree/1/ ← 404",
        ...
        "===============================",
        "http://localhost:8000/admin/snippets/wagtail_devtools_test/testsnippetone/edit/1/ ← 404",
        "http://localhost:8000/admin/snippets/wagtail_devtools_test/testsnippetthree/edit/1/ ← 404",
        "http://localhost:8000/admin/snippets/wagtail_devtools_test/testsnippettwo/edit/1/ ← 404",
        "",
        "USERS list page ...",
        "====================",
        ...
        "==============================",
        "http://localhost:8000/admin/wagtail_devtools_test/testmodeladminone/edit/1/ ← 404",
        "",
        ...
        "==============================",
        "http://localhost:8000/admin/wagtail_devtools_test/testmodeladmintwo/edit/1/ ← 404",
        "",
        ...
        "================================",
        "http://localhost:8000/admin/wagtail_devtools_test/testmodeladminthree/edit/1/ ← 404",
    ]
